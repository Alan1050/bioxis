...
const translations = {
  es: {
    ...
    collaborators: {
      eyebrow: 'Tres divisiones, una misión',
      title: 'Divisiones BIOXIS',
      description: 'Conoce las tres divisiones que forman BIOXIS, su liderazgo general y a las personas que aportan experiencia, investigación y creatividad a cada misión.',
      divisionNavAria: 'Ir a una división',
      divisionKicker: 'División',
      team: 'Equipo',
      leader: 'Liderazgo general de BIOXIS',
      areaLeader: 'Líder de División',
      member: 'Integrante',
  ...
  en: {
    ...
    collaborators: {
      eyebrow: 'Three divisions, one mission',
      title: 'BIOXIS Divisions',
      description: 'Meet the three divisions that make up BIOXIS, its general leadership, and the people contributing experience, research, and creativity to every mission.',
      divisionNavAria: 'Jump to a division',
      divisionKicker: 'Division',
      team: 'Team',
      leader: 'BIOXIS general leadership',
      areaLeader: 'Division Leader',
      member: 'Member',
      fullName: 'Full name',
      specialty: 'Specialty',
